...
void ErrorHandler::logInfo(const std::string& module, ErrorCodes::Compression errorCode, ErrorCodes::Compression infoCode, const std::string& context) {
    std::cerr << "[" << module << "] Error Code: " << static_cast<int>(errorCode) << " | Context: " << context << std::endl;
